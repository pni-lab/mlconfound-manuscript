...
\begin{figure}[!b]
  \centering
  \includegraphics[width=0.5\paperwidth]{fig/sim_h0_demo.pdf}
...
\begin{figure}[!b]
  \centering
  \includegraphics[width=0.6\paperwidth]{fig/overview.pdf}
...
\begin{figure}[!b]
  \centering
  \includegraphics[width=0.6\paperwidth]{fig/sim_normal.pdf}
...
\begin{figure}[!b]
  ...
  \includegraphics[width=0.5\paperwidth]{fig/sim_non-norm.pdf}
